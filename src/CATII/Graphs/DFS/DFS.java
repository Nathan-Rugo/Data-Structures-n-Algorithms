...
class Link3 {
    ...
    public Link3 next;  // Next link in the list
...
class LinkList3 {
    private Link3 first;  // Reference to the first link in the list
    ...
    public void insertFirst(int vertexId) {
        Link3 newLink = new Link3(vertexId);
        newLink.next = first;
        first = newLink;
    }

    // Find an unvisited vertex in the adjacency list
    public int findUnvisitedVertex(Vertex3[] vertexList) {
        Link3 current = first;
        while (current != null) {
...
class Vertex3 {
    ...
    public LinkList3 adjacencyList;  // Adjacency list for the vertex

    // Constructor to initialize the vertex
    public Vertex3(char lab) {
        label = lab;
        wasVisited = false;
        adjacencyList = new LinkList3();
    }
}
...
class Graph3 {
    ...
    private Vertex3[] vertexList;  // Array of vertices
